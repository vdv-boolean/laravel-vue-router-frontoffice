...
<template>
  <div class="container mt-5">
    ...
    <div class="row">
      <div class="col-md-6">
        ...
        <p>
          ...
          un'atmosfera suggestiva e intima, che vi farà sentire subito a vostro
          agio.
        </p>
      </div>
      <div class="col-md-6">
        ...
        <p>
          ...
          d'arte, preparata con ingredienti freschi e di alta qualità. Dalle
    ...
    <p>
      ...
      visita al Booltails Bar unica e memorabile.
    </p>
    ...
    <p>
      ...
      per prenotare il vostro evento speciale e far sì che sia davvero
      indimenticabile.
    </p>
  </div>
</template>
